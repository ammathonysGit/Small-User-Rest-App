...
public class TruckController {
    ...
    public ResponseEntity getAllTrucks() {
        ...
        if (truckMap.isEmpty() || truckMap == null) {
            return new ResponseEntity(new CustomMessage(new Date(), "Sorry there are np trucks currently"), HttpStatus.NOT_FOUND);
        } else {
    ...
    @GetMapping(path = "/brand/{brandname}", consumes = {MediaType.APPLICATION_JSON}, produces = {MediaType.APPLICATION_JSON})
